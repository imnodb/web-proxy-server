...
function _replySync(socket, code, reason, headers, cb) {
    try {
...
function _requestHandler(req, res) {
    try {
    ...
    function requestRemote(requestOptions, req, res, proxy) {
        const remoteRequest = http.request(requestOptions, function (remoteResponse) {
...
function _connectHandler(req, socket, head) {
    try {
        const requestOptions = {
